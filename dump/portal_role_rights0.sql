...
CREATE TABLE `role_rights` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_role_id_idx` (`right_id`),
  KEY `fk_role_id_idx1` (`role_id`),
  CONSTRAINT `fk_right_id` FOREIGN KEY (`right_id`) REFERENCES `rights_master` (`id`),
...
INSERT INTO `role_rights` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,1,5),(100,84,1),(101,84,2),(102,85,1),(103,85,2),(104,86,4),(105,86,5),(106,87,1),(107,87,3),(108,87,5),(109,88,1),(110,88,3),(145,119,1),(146,119,2),(147,119,3),(160,121,1);
